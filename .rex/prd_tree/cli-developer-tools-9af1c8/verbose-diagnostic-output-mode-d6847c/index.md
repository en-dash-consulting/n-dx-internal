...
| [Capture and surface spawn child process stderr in verbose mode](./capture-and-surface-spawn-child-ab7683.md) | pending |
| [Extend tests to verify --verbose produces additional diagnostic output and passes CI on macOS and Linux](./extend-tests-to-verify-verbose-5ed4a9.md) | pending |
| [Implement verbose LLM error output including raw response body excerpt and stack trace](./implement-verbose-llm-error-abeb1d.md) | pending |
| [Write regression tests for default error code emission across all major error categories](./write-regression-tests-for-d5fa88.md) | pending |
