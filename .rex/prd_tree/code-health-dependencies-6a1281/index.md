...
| [Fix code in project-scaffold (1 finding)](./fix-code-in-project-scaffold-1-finding/index.md) | completed |
| [Fix code in rex (1 finding)](./fix-code-in-rex-1-finding/index.md) | completed |
| [Fix code in rex-recommend (1 finding)](./fix-code-in-rex-recommend-1-finding/index.md) | completed |
| [Fix code in sourcevision-analyzers (2 findings)](./fix-code-in-sourcevision-3e8d85/index.md) | completed |
| [Fix code in sourcevision-view-tests (1 finding)](./fix-code-in-sourcevision-view-6fe462/index.md) | completed |
| [Fix code in task-usage-scheduler (3 findings)](./fix-code-in-task-usage-05826b/index.md) | completed |
| [Fix code in viewer-data-loader (1 finding)](./fix-code-in-viewer-data-loader-0ee552/index.md) | completed |
| [Fix code in web-helpers (1 finding)](./fix-code-in-web-helpers-1-finding/index.md) | completed |
| [Fix code in web-server (1 finding)](./fix-code-in-web-server-1-finding/index.md) | completed |
| [Fix code in web-viewer (3 findings)](./fix-code-in-web-viewer-3-findings/index.md) | completed |
| [Fix documentation in sourcevision-view-tests (1 finding)](./fix-documentation-in-a7e094/index.md) | completed |
| [Fix documentation in integration (1 finding)](./fix-documentation-in-c172d6/index.md) | completed |
| [Fix documentation in global (8 findings)](./fix-documentation-in-global-8-findings/index.md) | completed |
| [Fix documentation in packages-web:unit-server (1 finding)](./fix-documentation-in-packages-f223f7/index.md) | completed |
| [Fix documentation in rex (1 finding)](./fix-documentation-in-rex-1-finding/index.md) | completed |
| [Fix documentation in web-helpers (2 findings)](./fix-documentation-in-web-9df717/index.md) | completed |
| [Fix documentation in web-server (2 findings)](./fix-documentation-in-web-server-e985fe/index.md) | completed |
| [Fix move-file in core (1 finding)](./fix-move-file-in-core-1-finding/index.md) | completed |
...
| [Fix observation in tick (1 finding)](./fix-observation-in-tick-1-finding/index.md) | completed |
| [Fix observation in token (2 findings)](./fix-observation-in-token-2-findings/index.md) | completed |
| [Fix observation in use (1 finding)](./fix-observation-in-use-1-finding/index.md) | completed |
| [Fix observation in viewer-data-loader (1 finding)](./fix-observation-in-viewer-data-9ba16b/index.md) | completed |
| [Fix observation in viewer-ui-hub (2 findings)](./fix-observation-in-viewer-ui-d4b40f/index.md) | completed |
| [Fix observation in web-2 (2 findings)](./fix-observation-in-web-2-2-findings/index.md) | completed |
| [Fix observation in web-3 (2 findings)](./fix-observation-in-web-3-2-findings/index.md) | completed |
...
| [Fix structural in rex-fix-command (1 finding)](./fix-structural-in-rex-fix-5d586d/index.md) | completed |
| [Fix structural in rex-fix-data-model (1 finding)](./fix-structural-in-rex-fix-data-402337/index.md) | completed |
| [Fix structural in sourcevision-view-layer (2 findings)](./fix-structural-in-sourcevision-59749a/index.md) | completed |
| [Fix structural in theme-toggle (1 finding)](./fix-structural-in-theme-toggle-21c03c/index.md) | completed |
| [Fix structural in viewer-polling-engine (1 finding)](./fix-structural-in-viewer-40e86e/index.md) | completed |
| [Fix structural in viewer-data-loader (1 finding)](./fix-structural-in-viewer-data-15fc8e/index.md) | completed |
| [Fix structural in viewer-data-hooks (1 finding)](./fix-structural-in-viewer-data-3007df/index.md) | completed |
| [Fix structural in viewer-ui-hub (2 findings)](./fix-structural-in-viewer-ui-hub-bc5def/index.md) | completed |
