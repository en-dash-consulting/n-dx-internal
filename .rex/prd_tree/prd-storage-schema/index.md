...
PRD persistence model: folder-tree storage, markdown serialization, schema evolution, visibility/reporting, branch attribution, and the migration history that produced the current single-source-of-truth tree at .rex/prd_tree/.

## Progress

| Child | Level | Status | Last Updated |
|-------|-------|--------|--------------|
| Automatic prd.json Detection, Backup, and Migration on PRD-Touching Commands | feature | completed | 2026-04-30 |
| Branch Attribution Display in PRD Dashboard | feature | completed | 2026-04-24 |
| Branch Attribution Metadata on PRD Items | feature | completed | 2026-04-24 |
| CLI and MCP Write Command Integration with Folder Tree | feature | completed | 2026-04-28 |
