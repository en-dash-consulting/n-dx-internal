import type { Manifest, Inventory, Imports, Zones, Components, CallGraph, Classifications, ViewId } from "./external.js";
...
export interface FileDetail {
  ...
  archetypeSource?: "algorithmic" | "llm" | "user-override";
}
