...
Outgoing (this zone → other zones):
  → cli: src/cli/commands/usage.ts → src/cli/commands/constants.ts; src/cli/commands/usage.ts → src/cli/errors.ts; src/cli/commands/usage.ts → src/cli/output.ts
  → store: src/cli/commands/usage.ts → src/store/index.ts; src/core/token-usage.ts → src/store/index.ts
  → unit-analyze: src/core/token-usage.ts → src/schema/index.ts; tests/unit/core/token-usage-regression.test.ts → src/schema/index.ts; tests/unit/core/token-usage.test.ts → src/schema/index.ts

Incoming (other zones → this zone):
  ← cli: src/cli/index.ts → src/cli/commands/usage.ts
  ← unit-analyze: src/cli/commands/analyze.ts → src/core/token-usage.ts; src/cli/commands/status.ts → src/core/token-usage.ts; src/cli/commands/status.ts → src/core/token-usage.ts; tests/unit/cli/commands/usage.test.ts → src/cli/commands/usage.ts

</imports>

<findings>

[observation] [warning] High coupling (0.71) — 3 imports target "cli"
[observation] [warning] Low cohesion (0.29) — files are loosely related, consider splitting this zone
[suggestion] [info] Zone "usage" was identified from filename patterns, not directory structure — consider creating src/cli/commands/usage/ and moving related files there
[suggestion] [critical] Zone "Usage" (usage) has catastrophic risk (score: 0.71, cohesion: 0.29, coupling: 0.71) — requires immediate architectural intervention
