/**
 * Importability test: error code registry from @n-dx/llm-client within rex.
 *
 * Verifies that:
 * 1. All error code constants are reachable from the rex package context
...
describe("error code registry — importable from rex", () => {
