...
Severity guide: misplaced files are "warning". Missing abstractions and tight coupling are "warning" or "critical" based on blast radius. Test files coupling to their implementation subjects is expected and normal — do not flag it as an anti-pattern.`,
