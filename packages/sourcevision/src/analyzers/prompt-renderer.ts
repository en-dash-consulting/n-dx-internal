/**
 * Verbosity-aware prompt rendering for sourcevision LLM call sites.
 *
 * Wraps @n-dx/llm-client's renderPrompt with a module-level verbosity state so
 * every call site in the analysis pipeline automatically uses the configured
 ...
 *
 * @module analyzers/prompt-renderer
 */
...
/**
 * Current verbosity level for sourcevision LLM prompts.
