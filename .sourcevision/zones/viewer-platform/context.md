# Viewer Platform — Zone Context

<!-- Per-zone context generated by Sourcevision. -->

<zone>

Zone: Viewer Platform (`viewer-platform`)
Files: 119, Cohesion: 0.97, Coupling: 0.03
Description: Schema validation engine and viewer component infrastructure supporting the dashboard's data display and interaction capabilities.
...
[observation] [info] Robust viewer infrastructure with high cohesion (0.97) effectively centralizing schema validation and component framework
...
- Largest zone in web package suggests this is the core application logic layer
- Bidirectional imports with web-3 indicate tight integration between viewer platform and PRD components
- Strong cohesion with schema validation and viewer components co-located suggests good domain boundaries
- Robust viewer infrastructure with high cohesion (0.97) effectively centralizing schema validation and component framework
