...
Files: 100, Cohesion: 0.97, Coupling: 0.03
Description: Primary agent lifecycle, analysis pipelines, and tool integrations driving the automation runtime.
Entry points: packages/hench/src/process/index.ts, packages/hench/src/schema/v1.ts, packages/hench/src/tools/rex.ts, packages/hench/src/tools/shell.ts
Lines: 20016
...
packages/hench/src/tools/dispatch.ts (TypeScript, 212 lines, source)
...
Internal:
  ...
  packages/hench/tests/unit/tools/git.test.ts → packages/hench/src/schema/v1.ts {DEFAULT_HENCH_CONFIG}
...
Outgoing (this zone → other zones):
  → hench-completion-validation: packages/hench/src/agent/index.ts → packages/hench/src/validation/completion.ts; packages/hench/src/agent/index.ts → packages/hench/src/validation/completion.ts; packages/hench/src/agent/lifecycle/cli-loop.ts → packages/hench/src/validation/completion.ts; packages/hench/src/public.ts → packages/hench/src/validation/completion.ts; packages/hench/src/tools/rex.ts → packages/hench/src/validation/completion.ts
  → hench-guardrails-layer: packages/hench/src/agent/lifecycle/loop.ts → packages/hench/src/guard/index.ts; packages/hench/src/schema/v1.ts → packages/hench/src/guard/contracts.ts; packages/hench/src/tools/files.ts → packages/hench/src/guard/paths.ts; packages/hench/tests/unit/tools/files.test.ts → packages/hench/src/guard/index.ts; packages/hench/tests/unit/tools/git.test.ts → packages/hench/src/guard/index.ts

Incoming (other zones → this zone):
  ← hench-completion-validation: packages/hench/src/validation/completion.ts → packages/hench/src/process/index.ts; packages/hench/tests/unit/tools/completion-validation.test.ts → packages/hench/src/tools/rex.ts
  ← hench-guardrails-layer: packages/hench/tests/unit/guard/guard-integration.test.ts → packages/hench/src/schema/v1.ts; packages/hench/tests/unit/tools/shell.test.ts → packages/hench/src/schema/v1.ts; packages/hench/tests/unit/tools/shell.test.ts → packages/hench/src/tools/shell.ts
...
[observation] [info] Add contract tests for process/index.ts, schema/v1.ts, and tool entrypoints to guarantee backwards compatibility for consumers.
[observation] [info] Formalize analysis/lifecycle/tool subpackages to capitalize on the 0.97 cohesion and clarify extension points.
[observation] [info] Maintain stable interfaces on the 5 imports into hench-2 and 5 into hench-3 so validation and guard layers remain decoupled.
...
- Keep the analysis and lifecycle services modular so cross-zone imports (5 into hench-2 and 5 into hench-3) remain through stable interfaces.
- Add contract tests for the exposed entrypoints (process/index.ts, schema/v1.ts, tools) to ensure downstream consumers see stable schemas.
- Use the high cohesion (0.97) to your advantage by formalizing internal subpackages (analysis, lifecycle, tools) as published facets for clarity.
- Maintain stable interfaces on the 5 imports into hench-2 and 5 into hench-3 so validation and guard layers remain decoupled.
- Add contract tests for process/index.ts, schema/v1.ts, and tool entrypoints to guarantee backwards compatibility for consumers.
- Formalize analysis/lifecycle/tool subpackages to capitalize on the 0.97 cohesion and clarify extension points.
- [call graph] 1877 internal calls, 6 outgoing, 66 incoming (cohesion: 1, coupling: 0)
...
- **Tests** (`hench/tests`): 48 files, cohesion 0.81, coupling 0.19
- **Tools** (`hench/tools`): 11 files, cohesion 0.77, coupling 0.23
- **Tests 2** (`hench/tests-2`): 25 files, cohesion 0.69, coupling 0.31
- **Tests 3** (`hench/tests-3`): 4 files, cohesion 0.29, coupling 0.71
- **Process** (`hench/process`): 9 files, cohesion 0.6, coupling 0.4
