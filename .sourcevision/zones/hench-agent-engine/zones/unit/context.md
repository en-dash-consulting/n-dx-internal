...
Files: 97, Cohesion: 0.90, Coupling: 0.10
Description: 97 files, primarily TypeScript
Entry points: packages/hench/src/agent/lifecycle/cli-loop.ts, packages/hench/src/agent/lifecycle/loop.ts, packages/hench/src/cli/commands/run.ts, packages/hench/src/cli/errors.ts, packages/hench/src/cli/output.ts, packages/hench/src/prd/llm-gateway.ts, packages/hench/src/prd/rex-gateway.ts, packages/hench/src/process/exec.ts, packages/hench/src/process/index.ts, packages/hench/src/process/memory-monitor.ts, packages/hench/src/schema/index.ts, packages/hench/src/schema/v1.ts, packages/hench/src/store/project-config.ts, packages/hench/src/tools/rex.ts
Lines: 26441
...
Cross-dependencies between sub-zones:
  ...
  hench/unit/agent → hench/unit/agent-lifecycle: 2
  hench/unit/agent → hench/unit/cli: 3
  hench/unit/agent → hench/unit/cli-2: 10
  hench/unit/agent → hench/unit/cli-commands: 3
  hench/unit/agent → hench/unit/store: 11
  hench/unit/agent-2 → hench/unit/agent: 2
  hench/unit/agent-2 → hench/unit/cli-2: 2
  hench/unit/agent-lifecycle → hench/unit/agent: 12
  hench/unit/agent-lifecycle → hench/unit/cli-2: 1
  hench/unit/cli → hench/unit/agent: 1
  hench/unit/cli → hench/unit/agent-2: 1
  hench/unit/cli → hench/unit/cli-2: 1
  hench/unit/cli → hench/unit/cli-commands: 1
  hench/unit/cli → hench/unit/store: 2
  hench/unit/cli-2 → hench/unit/agent: 2
  hench/unit/cli-commands → hench/unit/agent: 3
  hench/unit/cli-commands → hench/unit/cli: 5
  hench/unit/cli-commands → hench/unit/cli-2: 3
  hench/unit/cli-commands → hench/unit/store: 1
  hench/unit/store → hench/unit/cli: 2
...
- **Hench/unit/agent** (`hench/unit/agent`): 59 files, cohesion 0.81, coupling 0.19
  - Has 7 nested sub-zone(s)
- **Hench/unit/agent 2** (`hench/unit/agent-2`): 4 files, cohesion 0.33, coupling 0.67
- **Hench/unit/agent Lifecycle** (`hench/unit/agent-lifecycle`): 4 files, cohesion 0.17, coupling 0.83
- **Hench/unit/cli** (`hench/unit/cli`): 8 files, cohesion 0.5, coupling 0.5
- **Hench/unit/cli 2** (`hench/unit/cli-2`): 8 files, cohesion 0.3, coupling 0.7
- **Hench/unit/cli Commands** (`hench/unit/cli-commands`): 4 files, cohesion 0.13, coupling 0.87
- **Hench/unit/store** (`hench/unit/store`): 10 files, cohesion 0.45, coupling 0.55
