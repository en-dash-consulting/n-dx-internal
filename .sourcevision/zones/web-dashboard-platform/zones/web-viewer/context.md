...
Files: 219, Cohesion: 0.98, Coupling: 0.02
Description: 219 files, primarily TypeScript
...
Cross-dependencies between sub-zones:
  ...
  web-viewer/web-viewer/use → web-viewer/web-viewer/prune: 1
  web-viewer/web-viewer/use → web-viewer/web-viewer/web: 5
  web-viewer/web-viewer/use → web-viewer/web-viewer/web-2: 7
  web-viewer/web-viewer/use → web-viewer/web-viewer/web-3: 1
  web-viewer/web-viewer/use → web-viewer/web-viewer/web-4: 2
  web-viewer/web-viewer/web → web-viewer/web-viewer/use: 1
  web-viewer/web-viewer/web → web-viewer/web-viewer/web-2: 7
  web-viewer/web-viewer/web → web-viewer/web-viewer/web-viewer: 6
  web-viewer/web-viewer/web-2 → web-viewer/web-viewer/web: 4
  web-viewer/web-viewer/web-2 → web-viewer/web-viewer/web-3: 2
  web-viewer/web-viewer/web-2 → web-viewer/web-viewer/web-4: 4
  web-viewer/web-viewer/web-2 → web-viewer/web-viewer/web-viewer: 1
  web-viewer/web-viewer/web-3 → web-viewer/web-viewer/web: 1
  web-viewer/web-viewer/web-3 → web-viewer/web-viewer/web-2: 3
  web-viewer/web-viewer/web-3 → web-viewer/web-viewer/web-4: 2
  web-viewer/web-viewer/web-4 → web-viewer/web-viewer/web-2: 6
  web-viewer/web-viewer/web-unit → web-viewer/web-viewer/web-2: 6
  web-viewer/web-viewer/web-unit → web-viewer/web-viewer/web-3: 1
  web-viewer/web-viewer/web-unit → web-viewer/web-viewer/web-4: 1
  web-viewer/web-viewer/web-viewer → web-viewer/web-viewer/web: 3
...
- **Web Viewer/web Viewer/use** (`web-viewer/web-viewer/use`): 6 files, cohesion 0.38, coupling 0.62
- **Web Viewer/web Viewer/web** (`web-viewer/web-viewer/web`): 164 files, cohesion 0.95, coupling 0.05
  - Has 8 nested sub-zone(s)
- **Web Viewer/web Viewer/web 2** (`web-viewer/web-viewer/web-2`): 29 files, cohesion 0.65, coupling 0.35
- **Web Viewer/web Viewer/web 3** (`web-viewer/web-viewer/web-3`): 3 files, cohesion 0.2, coupling 0.8
- **Web Viewer/web Viewer/web 4** (`web-viewer/web-viewer/web-4`): 5 files, cohesion 0.27, coupling 0.73
- **Web Viewer/web Viewer/web Unit** (`web-viewer/web-viewer/web-unit`): 3 files, cohesion 1, coupling 0
- **Web Viewer/web Viewer/web Viewer** (`web-viewer/web-viewer/web-viewer`): 6 files, cohesion 0.47, coupling 0.53
