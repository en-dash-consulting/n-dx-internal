...
Cross-dependencies between sub-zones:
  web-viewer/web-viewer/crash → web-viewer/web-viewer/web: 3
  web-viewer/web-viewer/domain → web-viewer/web-viewer/web: 12
  web-viewer/web-viewer/domain → web-viewer/web-viewer/web-3: 8
  web-viewer/web-viewer/domain → web-viewer/web-viewer/web-viewer: 1
  web-viewer/web-viewer/status → web-viewer/web-viewer/web: 3
  web-viewer/web-viewer/web → web-viewer/web-viewer/crash: 2
  web-viewer/web-viewer/web → web-viewer/web-viewer/domain: 1
  web-viewer/web-viewer/web → web-viewer/web-viewer/status: 4
  web-viewer/web-viewer/web → web-viewer/web-viewer/web-2: 3
  web-viewer/web-viewer/web → web-viewer/web-viewer/web-3: 11
  web-viewer/web-viewer/web → web-viewer/web-viewer/web-4: 1
  web-viewer/web-viewer/web → web-viewer/web-viewer/web-viewer: 5
  web-viewer/web-viewer/web-2 → web-viewer/web-viewer/status: 1
  web-viewer/web-viewer/web-2 → web-viewer/web-viewer/web: 4
  web-viewer/web-viewer/web-2 → web-viewer/web-viewer/web-3: 1
  web-viewer/web-viewer/web-3 → web-viewer/web-viewer/web: 4
  web-viewer/web-viewer/web-4 → web-viewer/web-viewer/web: 8
  web-viewer/web-viewer/web-viewer → web-viewer/web-viewer/status: 1
  web-viewer/web-viewer/web-viewer → web-viewer/web-viewer/web: 9
...
- **Web Viewer/web Viewer/crash** (`web-viewer/web-viewer/crash`): 6 files, cohesion 0.67, coupling 0.33
- **Web Viewer/web Viewer/domain** (`web-viewer/web-viewer/domain`): 5 files, cohesion 0.27, coupling 0.73
- **Web Viewer/web Viewer/status** (`web-viewer/web-viewer/status`): 5 files, cohesion 0.31, coupling 0.69
- **Web Viewer/web Viewer/web** (`web-viewer/web-viewer/web`): 175 files, cohesion 0.88, coupling 0.13
  - Has 8 nested sub-zone(s)
- **Web Viewer/web Viewer/web 2** (`web-viewer/web-viewer/web-2`): 4 files, cohesion 0.31, coupling 0.69
- **Web Viewer/web Viewer/web 3** (`web-viewer/web-viewer/web-3`): 11 files, cohesion 0.42, coupling 0.58
- **Web Viewer/web Viewer/web 4** (`web-viewer/web-viewer/web-4`): 5 files, cohesion 0.43, coupling 0.57
- **Web Viewer/web Viewer/web Viewer** (`web-viewer/web-viewer/web-viewer`): 5 files, cohesion 0.37, coupling 0.63
