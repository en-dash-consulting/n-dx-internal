...
Files: 175, Cohesion: 0.88, Coupling: 0.13
Description: 175 files, primarily TypeScript
Entry points: packages/web/src/viewer/components/copy-link-button.ts, packages/web/src/viewer/components/elapsed-time.ts, packages/web/src/viewer/components/faq.ts, packages/web/src/viewer/components/prd-tree/compute.ts, packages/web/src/viewer/components/prd-tree/levels.ts, packages/web/src/viewer/components/prd-tree/prd-tree.ts, packages/web/src/viewer/components/prd-tree/types.ts, packages/web/src/viewer/components/theme-toggle.ts, packages/web/src/viewer/components/throttle-controls.ts, packages/web/src/viewer/components/ws-health-panel.ts, packages/web/src/viewer/external.ts, packages/web/src/viewer/hooks/use-crash-recovery.ts, packages/web/src/viewer/performance/index.ts, packages/web/src/viewer/polling/index.ts, packages/web/src/viewer/polling/polling-manager.ts, packages/web/src/viewer/types.ts, packages/web/src/viewer/utils.ts, packages/web/src/viewer/views/analysis.ts, packages/web/src/viewer/views/architecture.ts, packages/web/src/viewer/views/files.ts, packages/web/src/viewer/views/overview.ts, packages/web/src/viewer/views/prd.ts, packages/web/src/viewer/views/rex-dashboard.ts, packages/web/src/viewer/views/routes.ts, packages/web/src/viewer/views/suggestions.ts, packages/web/src/viewer/views/task-audit.ts, packages/web/src/viewer/views/zones.ts, packages/web/src/viewer/visualization/index.ts
Lines: 49444
...
Cross-dependencies between sub-zones:
  web-viewer/web-viewer/web/use → web-viewer/web-viewer/web/viewer: 1
  web-viewer/web-viewer/web/use → web-viewer/web-viewer/web/viewer-2: 7
  web-viewer/web-viewer/web/use → web-viewer/web-viewer/web/viewer-3: 3
  web-viewer/web-viewer/web/use → web-viewer/web-viewer/web/viewer-4: 1
  web-viewer/web-viewer/web/use → web-viewer/web-viewer/web/viewer-hooks: 2
  web-viewer/web-viewer/web/viewer → web-viewer/web-viewer/web/viewer-3: 1
  web-viewer/web-viewer/web/viewer → web-viewer/web-viewer/web/viewer-performance: 1
  web-viewer/web-viewer/web/viewer-2 → web-viewer/web-viewer/web/viewer: 4
  web-viewer/web-viewer/web/viewer-2 → web-viewer/web-viewer/web/viewer-4: 2
  web-viewer/web-viewer/web/viewer-2 → web-viewer/web-viewer/web/viewer-components: 1
  web-viewer/web-viewer/web/viewer-2 → web-viewer/web-viewer/web/viewer-hooks: 4
  web-viewer/web-viewer/web/viewer-3 → web-viewer/web-viewer/web/viewer-2: 6
  web-viewer/web-viewer/web/viewer-4 → web-viewer/web-viewer/web/viewer-2: 3
  web-viewer/web-viewer/web/viewer-4 → web-viewer/web-viewer/web/viewer-hooks: 2
  web-viewer/web-viewer/web/viewer-4 → web-viewer/web-viewer/web/viewer-performance: 1
  web-viewer/web-viewer/web/viewer-components → web-viewer/web-viewer/web/viewer: 10
  web-viewer/web-viewer/web/viewer-components → web-viewer/web-viewer/web/viewer-2: 1
  web-viewer/web-viewer/web/viewer-components → web-viewer/web-viewer/web/viewer-performance: 11
  web-viewer/web-viewer/web/viewer-hooks → web-viewer/web-viewer/web/viewer-2: 6
  web-viewer/web-viewer/web/viewer-performance → web-viewer/web-viewer/web/viewer: 1
  web-viewer/web-viewer/web/viewer-performance → web-viewer/web-viewer/web/viewer-2: 6
  web-viewer/web-viewer/web/viewer-performance → web-viewer/web-viewer/web/viewer-4: 1
  web-viewer/web-viewer/web/viewer-performance → web-viewer/web-viewer/web/viewer-components: 1
...
- **Web Viewer/web Viewer/web/use** (`web-viewer/web-viewer/web/use`): 6 files, cohesion 0.43, coupling 0.57
- **Web Viewer/web Viewer/web/viewer** (`web-viewer/web-viewer/web/viewer`): 42 files, cohesion 0.89, coupling 0.11
- **Web Viewer/web Viewer/web/viewer 2** (`web-viewer/web-viewer/web/viewer-2`): 31 files, cohesion 0.69, coupling 0.31
- **Web Viewer/web Viewer/web/viewer 3** (`web-viewer/web-viewer/web/viewer-3`): 9 files, cohesion 0.59, coupling 0.41
- **Web Viewer/web Viewer/web/viewer 4** (`web-viewer/web-viewer/web/viewer-4`): 3 files, cohesion 0.2, coupling 0.8
- **Web Viewer/web Viewer/web/viewer Components** (`web-viewer/web-viewer/web/viewer-components`): 21 files, cohesion 0.51, coupling 0.49
- **Web Viewer/web Viewer/web/viewer Hooks** (`web-viewer/web-viewer/web/viewer-hooks`): 5 files, cohesion 0.27, coupling 0.73
- **Web Viewer/web Viewer/web/viewer Performance** (`web-viewer/web-viewer/web/viewer-performance`): 58 files, cohesion 0.83, coupling 0.17
