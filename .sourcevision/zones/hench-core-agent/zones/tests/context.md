...
Files: 67, Cohesion: 0.89, Coupling: 0.11
Description: 67 files, primarily TypeScript
Entry points: packages/hench/src/store/index.ts, packages/hench/src/store/config.ts, packages/hench/src/schema/index.ts, packages/hench/src/cli/commands/config.ts, packages/hench/src/cli/commands/init.ts, packages/hench/src/cli/commands/run.ts, packages/hench/src/types/output.ts, packages/hench/src/schema/v1.ts, packages/hench/src/store/json.ts, packages/hench/src/tools/exec-shell.ts, packages/hench/src/process/index.ts, packages/hench/src/store/runs.ts, packages/hench/src/agent/planning/brief.ts
Lines: 15487
...
- **Unit** (`hench/tests/unit`): 52 files, cohesion 0.93, coupling 0.07
