...
Zone: Unit Cli (`packages-rex:unit-cli`)
...
Outgoing (this zone → other zones):
  → packages-rex:cli: packages/rex/src/cli/commands/fix.ts → packages/rex/src/cli/commands/constants.ts; packages/rex/src/cli/commands/fix.ts → packages/rex/src/cli/commands/constants.ts; packages/rex/src/cli/commands/fix.ts → packages/rex/src/cli/output.ts; packages/rex/src/cli/commands/fix.ts → packages/rex/src/cli/output.ts
  → packages-rex:core: packages/rex/src/core/fix.ts → packages/rex/src/core/tree.ts; packages/rex/src/core/fix.ts → packages/rex/src/core/tree.ts
...
Incoming (other zones → this zone):
  ← packages-rex:cli: packages/rex/src/cli/index.ts → packages/rex/src/cli/commands/fix.ts; packages/rex/src/cli/index.ts → packages/rex/src/cli/commands/fix.ts
