...
Files: 112, Cohesion: 0.95, Coupling: 0.05
...
- **Hench/unit/agent** (`hench/unit/agent`): 80 files, cohesion 0.87, coupling 0.13
  - Has 6 nested sub-zone(s)
- **Hench/unit/agent Lifecycle** (`hench/unit/agent-lifecycle`): 4 files, cohesion 0.36, coupling 0.64
- **Hench/unit/cli** (`hench/unit/cli`): 14 files, cohesion 0.62, coupling 0.38
- **Hench/unit/schema** (`hench/unit/schema`): 5 files, cohesion 0.38, coupling 0.63
- **Hench/unit/store** (`hench/unit/store`): 9 files, cohesion 0.2, coupling 0.8
