# Hench/unit/agent/agent Lifecycle — Zone Context

<!-- Per-zone context generated by Sourcevision. -->

<zone>

Zone: Hench/unit/agent/agent Lifecycle (`hench/unit/agent/agent-lifecycle`)
Files: 16, Cohesion: 0.54, Coupling: 0.46
Description: 16 files, primarily TypeScript
Entry points: packages/hench/src/agent/lifecycle/cli-loop.ts, packages/hench/src/agent/lifecycle/loop.ts, packages/hench/src/agent/lifecycle/token-budget.ts, packages/hench/src/store/project-config.ts
Lines: 3920
