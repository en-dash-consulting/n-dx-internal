...
Files: 80, Cohesion: 0.87, Coupling: 0.13
Description: 80 files, primarily TypeScript
Entry points: packages/hench/src/agent/lifecycle/cli-loop.ts, packages/hench/src/agent/lifecycle/loop.ts, packages/hench/src/agent/planning/brief.ts, packages/hench/src/cli/commands/config.ts, packages/hench/src/cli/commands/init.ts, packages/hench/src/cli/commands/run.ts, packages/hench/src/prd/rex-gateway.ts, packages/hench/src/process/index.ts, packages/hench/src/process/memory-monitor.ts, packages/hench/src/schema/index.ts, packages/hench/src/schema/v1.ts, packages/hench/src/store/config.ts, packages/hench/src/store/index.ts, packages/hench/src/tools/exec-shell.ts, packages/hench/src/tools/rex.ts
Lines: 24387
...
Cross-dependencies between sub-zones:
  hench/unit/agent/agent → hench/unit/agent/agent-lifecycle: 10
  hench/unit/agent/agent → hench/unit/agent/analysis: 2
  hench/unit/agent/agent → hench/unit/agent/cli: 3
  hench/unit/agent/agent → hench/unit/agent/process: 6
  hench/unit/agent/agent-lifecycle → hench/unit/agent/agent: 4
  hench/unit/agent/agent-lifecycle → hench/unit/agent/analysis: 3
  hench/unit/agent/agent-lifecycle → hench/unit/agent/cli: 8
  hench/unit/agent/agent-lifecycle → hench/unit/agent/process: 13
  hench/unit/agent/agent-lifecycle → hench/unit/agent/store: 4
  hench/unit/agent/analysis → hench/unit/agent/process: 8
  hench/unit/agent/cli → hench/unit/agent/agent-lifecycle: 2
  ...
  hench/unit/agent/store → hench/unit/agent/agent: 1
...
- **Hench/unit/agent/agent** (`hench/unit/agent/agent`): 10 files, cohesion 0.14, coupling 0.86
- **Hench/unit/agent/agent Lifecycle** (`hench/unit/agent/agent-lifecycle`): 11 files, cohesion 0.3, coupling 0.7
...
- **Hench/unit/agent/process** (`hench/unit/agent/process`): 33 files, cohesion 0.67, coupling 0.33
- **Hench/unit/agent/store** (`hench/unit/agent/store`): 6 files, cohesion 0.5, coupling 0.5
