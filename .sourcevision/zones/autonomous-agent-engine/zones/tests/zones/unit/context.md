...
Files: 38, Cohesion: 0.81, Coupling: 0.19
Description: 38 files, primarily TypeScript
Entry points: packages/hench/src/agent/analysis/review.ts, packages/hench/src/agent/analysis/summary.ts, packages/hench/src/agent/lifecycle/token-budget.ts, packages/hench/src/agent/lifecycle/token-usage.ts, packages/hench/src/agent/planning/brief.ts, packages/hench/src/agent/planning/prompt.ts, packages/hench/src/schema/index.ts, packages/hench/src/cli/commands/config.ts, packages/hench/src/cli/commands/template.ts, packages/hench/src/schema/v1.ts, packages/hench/src/agent/lifecycle/cli-loop.ts
Lines: 10189
...
packages/hench/src/agent/planning/brief.ts (TypeScript, 341 lines, source)
