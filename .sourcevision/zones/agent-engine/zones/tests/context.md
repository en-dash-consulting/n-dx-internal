...
- **Unit** (`hench/tests/unit`): 60 files, cohesion 0.94, coupling 0.06
  - Has 4 nested sub-zone(s)
- **Unit 2** (`hench/tests/unit-2`): 4 files, cohesion 0.38, coupling 0.63
- **Process** (`hench/tests/process`): 9 files, cohesion 0.69, coupling 0.31
