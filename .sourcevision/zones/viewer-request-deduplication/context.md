# Viewer Request Deduplication — Zone Context

<!-- Per-zone context generated by Sourcevision. -->

<zone>

Zone: Viewer Request Deduplication (`viewer-request-deduplication`)
Files: 3, Cohesion: 0.40, Coupling: 0.60
Risk: healthy (score: 0.60)
Description: Prevents duplicate in-flight requests to the backend by tracking pending request keys, with a specialized test covering its use in the execution panel.
