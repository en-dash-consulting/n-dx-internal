...
Outgoing (this zone → other zones):
  → packages-rex:cli: packages/rex/src/cli/commands/usage.ts → packages/rex/src/cli/commands/constants.ts; packages/rex/src/cli/commands/usage.ts → packages/rex/src/cli/commands/constants.ts; packages/rex/src/cli/commands/usage.ts → packages/rex/src/cli/errors.ts; packages/rex/src/cli/commands/usage.ts → packages/rex/src/cli/errors.ts; packages/rex/src/cli/commands/usage.ts → packages/rex/src/cli/output.ts; packages/rex/src/cli/commands/usage.ts → packages/rex/src/cli/output.ts
  → packages-rex:store: packages/rex/src/cli/commands/usage.ts → packages/rex/src/store/index.ts; packages/rex/src/cli/commands/usage.ts → packages/rex/src/store/index.ts; packages/rex/src/core/token-usage.ts → packages/rex/src/store/index.ts; packages/rex/src/core/token-usage.ts → packages/rex/src/store/index.ts
  → packages-rex:unit-analyze: packages/rex/src/core/token-usage.ts → packages/rex/src/schema/index.ts; packages/rex/src/core/token-usage.ts → packages/rex/src/schema/index.ts; packages/rex/tests/unit/core/token-usage-regression.test.ts → packages/rex/src/schema/index.ts; packages/rex/tests/unit/core/token-usage-regression.test.ts → packages/rex/src/schema/index.ts; packages/rex/tests/unit/core/token-usage.test.ts → packages/rex/src/schema/index.ts; packages/rex/tests/unit/core/token-usage.test.ts → packages/rex/src/schema/index.ts

Incoming (other zones → this zone):
  ← packages-rex:cli: packages/rex/src/cli/index.ts → packages/rex/src/cli/commands/usage.ts; packages/rex/src/cli/index.ts → packages/rex/src/cli/commands/usage.ts
  ← packages-rex:unit-analyze: packages/rex/src/cli/commands/analyze.ts → packages/rex/src/core/token-usage.ts; packages/rex/src/cli/commands/analyze.ts → packages/rex/src/core/token-usage.ts; packages/rex/src/cli/commands/status.ts → packages/rex/src/core/token-usage.ts; packages/rex/src/cli/commands/status.ts → packages/rex/src/core/token-usage.ts; packages/rex/src/cli/commands/status.ts → packages/rex/src/core/token-usage.ts; packages/rex/src/cli/commands/status.ts → packages/rex/src/core/token-usage.ts; packages/rex/tests/unit/cli/commands/usage.test.ts → packages/rex/src/cli/commands/usage.ts; packages/rex/tests/unit/cli/commands/usage.test.ts → packages/rex/src/cli/commands/usage.ts

</imports>

<findings>

[suggestion] [critical] Zone "Usage" (packages-rex:usage) has catastrophic risk (score: 0.71, cohesion: 0.29, coupling: 0.71) — requires immediate architectural intervention
...
- High coupling (0.71) — 3 imports target "cli"
...
- The usage zone's sub-minimum file count (4) and lowest cohesion (0.29) are consistent with a zone that was split off mechanically by the Louvain algorithm rather than by deliberate design. In the absence of a zone archetype policy (finding 7), this outcome is expected and will recur for any small, loosely connected cluster. The fix is policy-level (define minimum viable zone sizes), not zone-level.
- Zone "usage" was identified from filename patterns, not directory structure — consider creating src/cli/commands/usage/ and moving related files there
