...
Files: 67, Cohesion: 0.96, Coupling: 0.04
Description: 67 files, primarily TypeScript
Entry points: packages/web/src/server/rex-gateway.ts, packages/web/src/server/routes-mcp.ts, packages/web/src/viewer/views/pr-markdown.ts
Lines: 27144
