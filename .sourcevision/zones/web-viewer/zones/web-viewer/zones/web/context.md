...
Files: 146, Cohesion: 0.92, Coupling: 0.08
Description: 146 files, primarily TypeScript
Entry points: packages/web/src/viewer/components/copy-link-button.ts, packages/web/src/viewer/components/prd-tree/execution-panel.ts, packages/web/src/viewer/components/rex-task-link.ts, packages/web/src/viewer/components/theme-toggle.ts, packages/web/src/viewer/hooks/use-crash-recovery.ts, packages/web/src/viewer/hooks/use-polling.ts, packages/web/src/viewer/performance/index.ts, packages/web/src/viewer/types.ts, packages/web/src/viewer/utils.ts, packages/web/src/viewer/visualization/index.ts
Lines: 36958
...
Cross-dependencies between sub-zones:
  web-viewer/web-viewer/web/integration → web-viewer/web-viewer/web/unit: 4
  web-viewer/web-viewer/web/integration → web-viewer/web-viewer/web/viewer: 4
  web-viewer/web-viewer/web/integration → web-viewer/web-viewer/web/viewer-2: 1
  web-viewer/web-viewer/web/integration → web-viewer/web-viewer/web/viewer-components: 1
  web-viewer/web-viewer/web/integration → web-viewer/web-viewer/web/viewer-hooks: 1
  web-viewer/web-viewer/web/integration → web-viewer/web-viewer/web/viewer-views: 1
  web-viewer/web-viewer/web/unit → web-viewer/web-viewer/web/viewer-2: 5
  web-viewer/web-viewer/web/unit → web-viewer/web-viewer/web/viewer-components: 1
  web-viewer/web-viewer/web/unit → web-viewer/web-viewer/web/viewer-hooks: 1
  web-viewer/web-viewer/web/use → web-viewer/web-viewer/web/unit: 1
  web-viewer/web-viewer/web/use → web-viewer/web-viewer/web/viewer: 3
  web-viewer/web-viewer/web/use → web-viewer/web-viewer/web/viewer-2: 1
  web-viewer/web-viewer/web/use → web-viewer/web-viewer/web/viewer-components: 2
  web-viewer/web-viewer/web/viewer → web-viewer/web-viewer/web/unit: 1
  web-viewer/web-viewer/web/viewer → web-viewer/web-viewer/web/use: 2
  web-viewer/web-viewer/web/viewer → web-viewer/web-viewer/web/viewer-2: 1
  web-viewer/web-viewer/web/viewer-2 → web-viewer/web-viewer/web/unit: 5
  web-viewer/web-viewer/web/viewer-2 → web-viewer/web-viewer/web/use: 1
  web-viewer/web-viewer/web/viewer-2 → web-viewer/web-viewer/web/viewer: 1
  web-viewer/web-viewer/web/viewer-2 → web-viewer/web-viewer/web/viewer-hooks: 1
  web-viewer/web-viewer/web/viewer-components → web-viewer/web-viewer/web/unit: 1
  web-viewer/web-viewer/web/viewer-components → web-viewer/web-viewer/web/use: 4
  web-viewer/web-viewer/web/viewer-components → web-viewer/web-viewer/web/viewer: 12
  web-viewer/web-viewer/web/viewer-components → web-viewer/web-viewer/web/viewer-2: 4
  web-viewer/web-viewer/web/viewer-hooks → web-viewer/web-viewer/web/unit: 3
  web-viewer/web-viewer/web/viewer-hooks → web-viewer/web-viewer/web/viewer-2: 1
  web-viewer/web-viewer/web/viewer-views → web-viewer/web-viewer/web/viewer: 8
  web-viewer/web-viewer/web/viewer-views → web-viewer/web-viewer/web/viewer-2: 1
  web-viewer/web-viewer/web/viewer-views → web-viewer/web-viewer/web/viewer-components: 2
...
- **Web Viewer/web Viewer/web/integration** (`web-viewer/web-viewer/web/integration`): 3 files, cohesion 1, coupling 0
- **Web Viewer/web Viewer/web/unit** (`web-viewer/web-viewer/web/unit`): 41 files, cohesion 0.76, coupling 0.24
- **Web Viewer/web Viewer/web/use** (`web-viewer/web-viewer/web/use`): 9 files, cohesion 0.43, coupling 0.57
- **Web Viewer/web Viewer/web/viewer** (`web-viewer/web-viewer/web/viewer`): 51 files, cohesion 0.84, coupling 0.16
- **Web Viewer/web Viewer/web/viewer 2** (`web-viewer/web-viewer/web/viewer-2`): 12 files, cohesion 0.46, coupling 0.54
- **Web Viewer/web Viewer/web/viewer Components** (`web-viewer/web-viewer/web/viewer-components`): 22 files, cohesion 0.58, coupling 0.42
- **Web Viewer/web Viewer/web/viewer Hooks** (`web-viewer/web-viewer/web/viewer-hooks`): 3 files, cohesion 0.33, coupling 0.67
- **Web Viewer/web Viewer/web/viewer Views** (`web-viewer/web-viewer/web/viewer-views`): 5 files, cohesion 0.4, coupling 0.6
