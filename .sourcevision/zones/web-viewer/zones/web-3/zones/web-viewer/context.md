...
Cross-dependencies between sub-zones:
  web-viewer/web-3/web-viewer/use → web-viewer/web-3/web-viewer/web: 2
  web-viewer/web-3/web-viewer/use → web-viewer/web-3/web-viewer/web-unit: 1
  web-viewer/web-3/web-viewer/web → web-viewer/web-3/web-viewer/use: 3
  web-viewer/web-3/web-viewer/web → web-viewer/web-3/web-viewer/web-unit: 1
  web-viewer/web-3/web-viewer/web → web-viewer/web-3/web-viewer/web-viewer: 1
  web-viewer/web-3/web-viewer/web-unit → web-viewer/web-3/web-viewer/web: 8
  web-viewer/web-3/web-viewer/web-viewer → web-viewer/web-3/web-viewer/web: 5
...
- **Web Viewer/web 3/web Viewer/use** (`web-viewer/web-3/web-viewer/use`): 4 files, cohesion 0.5, coupling 0.5
- **Web Viewer/web 3/web Viewer/web** (`web-viewer/web-3/web-viewer/web`): 40 files, cohesion 0.89, coupling 0.11
- **Web Viewer/web 3/web Viewer/web Unit** (`web-viewer/web-3/web-viewer/web-unit`): 3 files, cohesion 1, coupling 0
- **Web Viewer/web 3/web Viewer/web Viewer** (`web-viewer/web-3/web-viewer/web-viewer`): 3 files, cohesion 0.29, coupling 0.71
