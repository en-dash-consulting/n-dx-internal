# Web UI Framework — Zone Context

<!-- Per-zone context generated by Sourcevision. -->

<zone>

Zone: Web UI Framework (`web-ui-framework`)
Files: 141, Cohesion: 0.97, Coupling: 0.03
Description: Core frontend components, schema validation, and shared UI infrastructure that powers the web dashboard interface.
Entry points: packages/web/src/viewer/components/guide.ts, packages/web/src/viewer/components/prd-tree/shared-imports.ts, packages/web/src/viewer/components/theme-toggle.ts, packages/web/src/viewer/views/pr-markdown.ts
Lines: 43970
...
packages/web/src/viewer/styles/index.css (CSS, 38 lines, other)
...
packages/web/src/viewer/styles/prd-tree.css (CSS, 4958 lines, other)
...
Internal:
  ...
  packages/web/src/viewer/components/refresh-queue-status.ts → packages/web/src/viewer/memory-monitor.ts {MemoryLevel}
  ...
  packages/web/src/viewer/hooks/use-refresh-throttle.ts → packages/web/src/viewer/memory-monitor.ts {MemoryLevel}
  ...
  packages/web/src/viewer/main.ts → packages/web/src/viewer/graceful-degradation.ts {DegradableFeature}
  ...
  packages/web/src/viewer/refresh-throttle.ts → packages/web/src/viewer/memory-monitor.ts {onSnapshot, getLatestSnapshot, getCurrentLevel}
  packages/web/src/viewer/refresh-throttle.ts → packages/web/src/viewer/memory-monitor.ts {MemoryLevel, MemorySnapshot}
  ...
  packages/web/tests/unit/viewer/refresh-throttle.test.ts → packages/web/src/viewer/memory-monitor.ts {startMemoryMonitor, resetMemoryMonitor}
...
Outgoing (this zone → other zones):
  → graph-visualization-engine: packages/web/src/viewer/graph/renderer.ts → packages/web/src/viewer/graph/physics.ts; packages/web/src/viewer/graph/renderer.ts → packages/web/src/viewer/graph/physics.ts
  ...
  → web-service-foundation: packages/web/src/viewer/loader.ts → packages/web/src/schema/data-files.ts; packages/web/src/viewer/main.ts → packages/web/src/schema/data-files.ts; packages/web/tests/unit/server/memory-leak-fixes.test.ts → packages/web/src/server/routes-mcp.ts
...
Incoming (other zones → this zone):
  ...
  ← web-service-foundation: packages/web/tests/integration/pr-markdown-refresh.test.ts → packages/web/src/viewer/views/pr-markdown.ts
...
- Excellent architectural structure with very high cohesion (0.97) and minimal coupling (0.03) despite managing 141 files
- Serves as the foundational layer that other web zones depend on, evidenced by incoming imports from web-3
- Successfully maintains cohesion across diverse UI concerns including schema validation, theming, and component library
- Exceptional cohesion-to-size ratio demonstrates mature modular design patterns
- [call graph] 1279 internal calls, 6 outgoing, 0 incoming (cohesion: 1, coupling: 0)
...
- **Web** (`web-2/web`): 68 files, cohesion 0.91, coupling 0.09
- **Web 2** (`web-2/web-2`): 7 files, cohesion 0.64, coupling 0.36
- **Web 3** (`web-2/web-3`): 7 files, cohesion 0.5, coupling 0.5
- **Web 4** (`web-2/web-4`): 10 files, cohesion 0.77, coupling 0.23
- **Web 5** (`web-2/web-5`): 4 files, cohesion 0.5, coupling 0.5
