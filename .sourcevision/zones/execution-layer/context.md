# Execution Layer — Zone Context

<!-- Per-zone context generated by Sourcevision. -->

<zone>

Zone: Execution Layer (`execution-layer`)
Files: 100, Cohesion: 1.00, Coupling: 0.00
Description: Autonomous agent system that executes PRD tasks through tool-use loops and workflow management.
Lines: 19827
...
[suggestion] [warning] Agent loop files contain minimal .catch() error handling (31 occurrences total) despite high async complexity - risk of unhandled promise rejections
