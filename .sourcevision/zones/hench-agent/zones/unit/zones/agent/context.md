...
Files: 73, Cohesion: 0.79, Coupling: 0.21
Description: 73 files, primarily TypeScript
Entry points: packages/hench/src/agent/analysis/summary.ts, packages/hench/src/agent/lifecycle/cli-loop.ts, packages/hench/src/agent/lifecycle/loop.ts, packages/hench/src/agent/lifecycle/token-budget.ts, packages/hench/src/agent/planning/prompt.ts, packages/hench/src/cli/commands/constants.ts, packages/hench/src/cli/errors.ts, packages/hench/src/cli/output.ts, packages/hench/src/process/index.ts, packages/hench/src/process/limiter.ts, packages/hench/src/process/memory-monitor.ts, packages/hench/src/process/memory-throttle.ts, packages/hench/src/schema/index.ts, packages/hench/src/schema/v1.ts, packages/hench/src/store/index.ts, packages/hench/src/store/project-config.ts, packages/hench/src/tools/exec-shell.ts
Lines: 19392
...
Cross-dependencies between sub-zones:
  ...
  hench/unit/agent/agent → hench/unit/agent/store: 5
  hench/unit/agent/cli → hench/unit/agent/process: 2
  hench/unit/agent/cli → hench/unit/agent/store: 3
  ...
  hench/unit/agent/store → hench/unit/agent/cli: 2
...
- **Hench/unit/agent/agent** (`hench/unit/agent/agent`): 16 files, cohesion 0.56, coupling 0.44
- **Hench/unit/agent/cli** (`hench/unit/agent/cli`): 14 files, cohesion 0.78, coupling 0.22
- **Hench/unit/agent/process** (`hench/unit/agent/process`): 37 files, cohesion 0.78, coupling 0.22
- **Hench/unit/agent/store** (`hench/unit/agent/store`): 6 files, cohesion 0.4, coupling 0.6
