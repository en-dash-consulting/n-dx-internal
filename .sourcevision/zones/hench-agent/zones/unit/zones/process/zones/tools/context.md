# Hench/unit/process/tools — Zone Context

<!-- Per-zone context generated by Sourcevision. -->

<zone>

Zone: Hench/unit/process/tools (`hench/unit/process/tools`)
Files: 14, Cohesion: 0.81, Coupling: 0.19
Description: 14 files, primarily TypeScript
Entry points: packages/hench/src/agent/tools.ts, packages/hench/src/process/memory-monitor.ts, packages/hench/src/tools/contracts.ts, packages/hench/src/tools/dispatch.ts, packages/hench/src/tools/index.ts, packages/hench/src/tools/shell.ts
Lines: 2647
