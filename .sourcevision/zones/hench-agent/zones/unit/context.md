...
Files: 120, Cohesion: 0.95, Coupling: 0.05
Description: 120 files, primarily TypeScript, JSON, Other
Entry points: packages/hench/src/agent/lifecycle/cli-loop.ts, packages/hench/src/cli/commands/run.ts, packages/hench/src/process/index.ts, packages/hench/src/process/memory-monitor.ts, packages/hench/src/schema/index.ts, packages/hench/src/schema/v1.ts, packages/hench/src/store/config.ts, packages/hench/src/tools/exec-shell.ts, packages/hench/src/tools/rex.ts
Lines: 30870
...
Cross-dependencies between sub-zones:
  hench/unit/agent → hench/unit/agent-2: 8
  hench/unit/agent → hench/unit/agent-analysis: 3
  hench/unit/agent → hench/unit/agent-lifecycle: 5
  hench/unit/agent → hench/unit/cli: 7
  hench/unit/agent → hench/unit/queue: 2
  hench/unit/agent → hench/unit/schema: 5
  hench/unit/agent-2 → hench/unit/agent: 9
  hench/unit/agent-2 → hench/unit/cli: 1
  hench/unit/agent-analysis → hench/unit/agent: 12
  hench/unit/agent-analysis → hench/unit/agent-lifecycle: 1
  hench/unit/agent-analysis → hench/unit/cli: 2
  hench/unit/agent-lifecycle → hench/unit/agent: 2
  hench/unit/cli → hench/unit/agent: 13
  hench/unit/cli → hench/unit/agent-analysis: 1
  hench/unit/cli → hench/unit/queue: 2
  hench/unit/schema → hench/unit/agent: 6
...
- **Hench/unit/agent** (`hench/unit/agent`): 73 files, cohesion 0.79, coupling 0.21
  - Has 4 nested sub-zone(s)
- **Hench/unit/agent 2** (`hench/unit/agent-2`): 6 files, cohesion 1, coupling 0
- **Hench/unit/agent Analysis** (`hench/unit/agent-analysis`): 8 files, cohesion 0.3, coupling 0.7
- **Hench/unit/agent Lifecycle** (`hench/unit/agent-lifecycle`): 4 files, cohesion 0.36, coupling 0.64
- **Hench/unit/cli** (`hench/unit/cli`): 10 files, cohesion 0.34, coupling 0.66
- **Hench/unit/hench** (`hench/unit/hench`): 7 files, cohesion 1, coupling 0
- **Hench/unit/queue** (`hench/unit/queue`): 7 files, cohesion 0.83, coupling 0.17
- **Hench/unit/schema** (`hench/unit/schema`): 5 files, cohesion 0.4, coupling 0.6
