...
Files: 60, Cohesion: 0.89, Coupling: 0.11
Description: 60 files, primarily TypeScript
Entry points: packages/hench/src/agent/analysis/stuck.ts, packages/hench/src/agent/lifecycle/cli-loop.ts, packages/hench/src/agent/lifecycle/loop.ts, packages/hench/src/agent/planning/brief.ts, packages/hench/src/store/index.ts, packages/hench/src/store/project-config.ts, packages/hench/src/store/config.ts, packages/hench/src/cli/commands/config.ts, packages/hench/src/cli/commands/init.ts, packages/hench/src/cli/commands/template.ts, packages/hench/src/types/output.ts, packages/hench/src/schema/v1.ts, packages/hench/src/schema/validate.ts, packages/hench/src/schema/index.ts, packages/hench/src/store/runs.ts
Lines: 14112
...
- **Unit** (`hench/tests/unit`): 30 files, cohesion 0.79, coupling 0.21
- **Unit 2** (`hench/tests/unit-2`): 23 files, cohesion 0.75, coupling 0.25
- **Types** (`hench/tests/types`): 4 files, cohesion 0.46, coupling 0.54
- **Unit 3** (`hench/tests/unit-3`): 3 files, cohesion 0.5, coupling 0.5
