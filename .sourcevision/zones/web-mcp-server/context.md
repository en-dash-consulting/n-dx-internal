...
Zone: Web MCP Server (`web-mcp-server`)
Files: 116, Cohesion: 0.96, Coupling: 0.04
Description: MCP HTTP server infrastructure and domain gateway integration logic.
Entry points: packages/web/src/viewer/components/copy-link-button.ts, packages/web/src/viewer/components/logos.ts, packages/web/src/viewer/components/theme-toggle.ts, packages/web/src/viewer/types.ts
Lines: 40444
