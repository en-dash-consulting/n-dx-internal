...
Files: 102, Cohesion: 0.91, Coupling: 0.09
Description: 102 files, primarily TypeScript
Entry points: packages/web/src/viewer/components/copy-link-button.ts, packages/web/src/viewer/components/logos.ts, packages/web/src/viewer/components/rex-task-link.ts, packages/web/src/viewer/components/theme-toggle.ts, packages/web/src/viewer/performance/crash-detector.ts, packages/web/src/viewer/types.ts, packages/web/src/viewer/usage/constants.ts
Lines: 27048
...
Cross-dependencies between sub-zones:
  web-viewer/web-viewer/crash → web-viewer/web-viewer/web: 2
  web-viewer/web-viewer/route → web-viewer/web-viewer/web: 6
  web-viewer/web-viewer/web → web-viewer/web-viewer/web-2: 1
  web-viewer/web-viewer/web → web-viewer/web-viewer/web-unit: 2
  web-viewer/web-viewer/web → web-viewer/web-viewer/web-viewer: 2
  web-viewer/web-viewer/web-2 → web-viewer/web-viewer/crash: 1
  web-viewer/web-viewer/web-2 → web-viewer/web-viewer/route: 1
  web-viewer/web-viewer/web-2 → web-viewer/web-viewer/web: 8
...
- **Web Viewer/web Viewer/crash** (`web-viewer/web-viewer/crash`): 3 files, cohesion 0.4, coupling 0.6
- **Web Viewer/web Viewer/route** (`web-viewer/web-viewer/route`): 4 files, cohesion 0.4, coupling 0.6
- **Web Viewer/web Viewer/web** (`web-viewer/web-viewer/web`): 75 files, cohesion 0.93, coupling 0.07
  - Has 5 nested sub-zone(s)
- **Web Viewer/web Viewer/web 2** (`web-viewer/web-viewer/web-2`): 8 files, cohesion 0.35, coupling 0.65
- **Web Viewer/web Viewer/web Unit** (`web-viewer/web-viewer/web-unit`): 3 files, cohesion 1, coupling 0
- **Web Viewer/web Viewer/web Viewer** (`web-viewer/web-viewer/web-viewer`): 9 files, cohesion 0.72, coupling 0.28
