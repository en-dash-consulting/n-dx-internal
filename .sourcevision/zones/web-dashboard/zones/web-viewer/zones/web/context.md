...
Files: 73, Cohesion: 0.92, Coupling: 0.08
Description: 73 files, primarily TypeScript
Entry points: packages/web/src/schema/v1.ts, packages/web/src/viewer/components/logos.ts, packages/web/src/viewer/types.ts, packages/web/src/viewer/utils.ts, packages/web/src/viewer/views/sourcevision-tabs.ts, packages/web/src/viewer/visualization/index.ts
Lines: 17181
...
Cross-dependencies between sub-zones:
  web-viewer/web-viewer/web/domain → web-viewer/web-viewer/web/viewer: 5
  web-viewer/web-viewer/web/domain → web-viewer/web-viewer/web/viewer-2: 4
  web-viewer/web-viewer/web/domain → web-viewer/web-viewer/web/viewer-views: 7
  web-viewer/web-viewer/web/viewer → web-viewer/web-viewer/web/domain: 1
  web-viewer/web-viewer/web/viewer → web-viewer/web-viewer/web/viewer-views: 4
  web-viewer/web-viewer/web/viewer-2 → web-viewer/web-viewer/web/viewer: 10
  web-viewer/web-viewer/web/viewer-2 → web-viewer/web-viewer/web/viewer-views: 3
...
- **Web Viewer/web Viewer/web/domain** (`web-viewer/web-viewer/web/domain`): 5 files, cohesion 0.32, coupling 0.68
- **Web Viewer/web Viewer/web/viewer** (`web-viewer/web-viewer/web/viewer`): 53 files, cohesion 0.88, coupling 0.12
- **Web Viewer/web Viewer/web/viewer 2** (`web-viewer/web-viewer/web/viewer-2`): 5 files, cohesion 0.32, coupling 0.68
- **Web Viewer/web Viewer/web/viewer Views** (`web-viewer/web-viewer/web/viewer-views`): 10 files, cohesion 0.52, coupling 0.48
