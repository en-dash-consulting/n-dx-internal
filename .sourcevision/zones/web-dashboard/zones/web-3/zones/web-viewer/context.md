...
Cross-dependencies between sub-zones:
  web-viewer/web-3/web-viewer/use → web-viewer/web-3/web-viewer/web: 3
  web-viewer/web-3/web-viewer/web → web-viewer/web-3/web-viewer/use: 3
  web-viewer/web-3/web-viewer/web → web-viewer/web-3/web-viewer/web-2: 8
  web-viewer/web-3/web-viewer/web → web-viewer/web-3/web-viewer/web-viewer: 1
  web-viewer/web-3/web-viewer/web-2 → web-viewer/web-3/web-viewer/web: 6
...
- **Web Viewer/web 3/web Viewer/web** (`web-viewer/web-3/web-viewer/web`): 40 files, cohesion 0.82, coupling 0.18
- **Web Viewer/web 3/web Viewer/web 2** (`web-viewer/web-3/web-viewer/web-2`): 5 files, cohesion 0.29, coupling 0.71
