...
Cross-dependencies between sub-zones:
  web-viewer/web-3/prune → web-viewer/web-3/web: 5
  web-viewer/web-3/web → web-viewer/web-3/web-2: 2
  web-viewer/web-3/web-2 → web-viewer/web-3/web: 3
  web-viewer/web-3/web-viewer → web-viewer/web-3/prune: 1
  web-viewer/web-3/web-viewer → web-viewer/web-3/web: 12
  web-viewer/web-3/web-viewer → web-viewer/web-3/web-2: 2
...
- **Web Viewer/web 3/prune** (`web-viewer/web-3/prune`): 3 files, cohesion 0.29, coupling 0.71
- **Web Viewer/web 3/web** (`web-viewer/web-3/web`): 56 files, cohesion 0.87, coupling 0.13
  - Has 4 nested sub-zone(s)
- **Web Viewer/web 3/web 2** (`web-viewer/web-3/web-2`): 3 files, cohesion 0.25, coupling 0.75
- **Web Viewer/web 3/web Viewer** (`web-viewer/web-3/web-viewer`): 6 files, cohesion 0.42, coupling 0.58
