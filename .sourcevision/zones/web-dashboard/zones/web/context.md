...
Files: 278, Cohesion: 0.98, Coupling: 0.02
Description: 278 files, primarily TypeScript
Entry points: packages/web/src/viewer/components/logos.ts, packages/web/src/viewer/components/prd-tree/levels.ts, packages/web/src/viewer/components/rex-task-link.ts, packages/web/src/viewer/components/sidebar.ts, packages/web/src/viewer/hooks/use-polling.ts, packages/web/src/viewer/performance/graceful-degradation.ts, packages/web/src/viewer/performance/index.ts, packages/web/src/viewer/polling/index.ts, packages/web/src/viewer/types.ts, packages/web/src/viewer/visualization/index.ts
Lines: 88208
...
Cross-dependencies between sub-zones:
  web-viewer/web/unit → web-viewer/web/viewer: 2
  web-viewer/web/unit → web-viewer/web/viewer-components: 3
  web-viewer/web/unit-viewer → web-viewer/web/viewer: 6
  web-viewer/web/unit-viewer → web-viewer/web/viewer-2: 1
  web-viewer/web/viewer → web-viewer/web/unit-viewer: 7
  web-viewer/web/viewer → web-viewer/web/viewer-2: 4
  web-viewer/web/viewer → web-viewer/web/viewer-components: 10
  web-viewer/web/viewer-2 → web-viewer/web/unit-viewer: 2
  web-viewer/web/viewer-2 → web-viewer/web/viewer: 1
  web-viewer/web/viewer-2 → web-viewer/web/viewer-components: 6
  web-viewer/web/viewer-components → web-viewer/web/unit: 5
  web-viewer/web/viewer-components → web-viewer/web/unit-viewer: 4
  web-viewer/web/viewer-components → web-viewer/web/viewer: 27
  web-viewer/web/viewer-components → web-viewer/web/viewer-2: 6
...
- **Web Viewer/web/unit** (`web-viewer/web/unit`): 82 files, cohesion 0.94, coupling 0.06
  - Has 5 nested sub-zone(s)
- **Web Viewer/web/unit Viewer** (`web-viewer/web/unit-viewer`): 30 files, cohesion 0.61, coupling 0.39
- **Web Viewer/web/viewer** (`web-viewer/web/viewer`): 47 files, cohesion 0.69, coupling 0.31
- **Web Viewer/web/viewer 2** (`web-viewer/web/viewer-2`): 62 files, cohesion 0.9, coupling 0.1
  - Has 3 nested sub-zone(s)
- **Web Viewer/web/viewer Components** (`web-viewer/web/viewer-components`): 57 files, cohesion 0.74, coupling 0.26
  - Has 3 nested sub-zone(s)
