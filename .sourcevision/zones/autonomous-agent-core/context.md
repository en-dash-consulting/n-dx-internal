...
Zone: Autonomous Agent Core (`autonomous-agent-core`)
...
packages/hench/src/schema/v1.ts (TypeScript, 223 lines, source)
...
Outgoing (this zone → other zones):
  → agent-security-layer: packages/hench/src/agent/lifecycle/loop.ts → packages/hench/src/guard/index.ts; packages/hench/src/schema/v1.ts → packages/hench/src/guard/contracts.ts; packages/hench/src/tools/files.ts → packages/hench/src/guard/paths.ts

Incoming (other zones → this zone):
  ← agent-security-layer: packages/hench/tests/unit/guard/guard-integration.test.ts → packages/hench/src/schema/v1.ts; packages/hench/tests/unit/tools/shell.test.ts → packages/hench/src/schema/v1.ts; packages/hench/tests/unit/tools/shell.test.ts → packages/hench/src/tools/shell.ts
...
[observation] [info] Analysis subdirectory structure (adaptive, review, stuck) suggests robust agent state management
[observation] [info] Excellent cohesion (0.99) across 106 files demonstrates well-organized agent subsystems
[observation] [info] Minimal external coupling (0.01) maintains agent independence from other domain packages
