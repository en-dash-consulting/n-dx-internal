...
Files: 60, Cohesion: 0.94, Coupling: 0.06
Description: 60 files, primarily TypeScript
Entry points: packages/hench/src/agent/analysis/stuck.ts, packages/hench/src/agent/lifecycle/cli-loop.ts, packages/hench/src/agent/lifecycle/loop.ts, packages/hench/src/agent/planning/brief.ts, packages/hench/src/store/index.ts, packages/hench/src/store/project-config.ts, packages/hench/src/schema/v1.ts, packages/hench/src/schema/validate.ts, packages/hench/src/store/config.ts
Lines: 14071
...
- **Agent** (`hench/tests/unit/agent`): 30 files, cohesion 0.79, coupling 0.21
- **Agent 2** (`hench/tests/unit/agent-2`): 23 files, cohesion 0.75, coupling 0.25
- **Agent 3** (`hench/tests/unit/agent-3`): 4 files, cohesion 0.46, coupling 0.54
- **Agent 4** (`hench/tests/unit/agent-4`): 3 files, cohesion 0.5, coupling 0.5
