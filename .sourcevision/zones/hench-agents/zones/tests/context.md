...
Files: 68, Cohesion: 0.88, Coupling: 0.12
Description: 68 files, primarily TypeScript
Entry points: packages/hench/src/store/index.ts, packages/hench/src/store/config.ts, packages/hench/src/schema/index.ts, packages/hench/src/cli/commands/config.ts, packages/hench/src/cli/commands/init.ts, packages/hench/src/cli/commands/run.ts, packages/hench/src/types/output.ts, packages/hench/src/schema/v1.ts, packages/hench/src/store/json.ts, packages/hench/src/tools/exec-shell.ts, packages/hench/src/process/index.ts, packages/hench/src/store/runs.ts, packages/hench/src/agent/planning/brief.ts, packages/hench/src/tools/rex.ts
Lines: 15552
...
- **Unit** (`hench/tests/unit`): 53 files, cohesion 0.93, coupling 0.07
  - Has 3 nested sub-zone(s)
- **Process** (`hench/tests/process`): 11 files, cohesion 0.69, coupling 0.31
- **Unit 2** (`hench/tests/unit-2`): 4 files, cohesion 0.38, coupling 0.63
