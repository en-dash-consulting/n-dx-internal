...
Files: 53, Cohesion: 0.93, Coupling: 0.07
Description: 53 files, primarily TypeScript
Entry points: packages/hench/src/types/output.ts, packages/hench/src/agent/analysis/stuck.ts, packages/hench/src/agent/lifecycle/cli-loop.ts, packages/hench/src/agent/lifecycle/loop.ts, packages/hench/src/agent/planning/brief.ts, packages/hench/src/store/index.ts, packages/hench/src/store/project-config.ts, packages/hench/src/schema/v1.ts, packages/hench/src/schema/validate.ts, packages/hench/src/store/config.ts
Lines: 12392
...
- **Agent** (`hench/tests/unit/agent`): 46 files, cohesion 0.95, coupling 0.05
- **Agent 2** (`hench/tests/unit/agent-2`): 4 files, cohesion 0.5, coupling 0.5
