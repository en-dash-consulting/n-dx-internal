...
Cross-dependencies between sub-zones:
  web-viewer/web-viewer/domain → web-viewer/web-viewer/web: 13
  web-viewer/web-viewer/domain → web-viewer/web-viewer/web-3: 1
  web-viewer/web-viewer/domain → web-viewer/web-viewer/web-viewer: 6
  web-viewer/web-viewer/prune → web-viewer/web-viewer/web-2: 5
  web-viewer/web-viewer/web → web-viewer/web-viewer/domain: 1
  web-viewer/web-viewer/web → web-viewer/web-viewer/prune: 1
  web-viewer/web-viewer/web → web-viewer/web-viewer/web-2: 14
  web-viewer/web-viewer/web → web-viewer/web-viewer/web-3: 3
  web-viewer/web-viewer/web → web-viewer/web-viewer/web-4: 1
  web-viewer/web-viewer/web → web-viewer/web-viewer/web-unit: 3
  web-viewer/web-viewer/web → web-viewer/web-viewer/web-viewer: 12
  ...
  web-viewer/web-viewer/web-4 → web-viewer/web-viewer/web: 8
  web-viewer/web-viewer/web-unit → web-viewer/web-viewer/web: 5
  web-viewer/web-viewer/web-viewer → web-viewer/web-viewer/web: 1
...
- **Web Viewer/web Viewer/web 4** (`web-viewer/web-viewer/web-4`): 5 files, cohesion 0.43, coupling 0.57
- **Web Viewer/web Viewer/web Unit** (`web-viewer/web-viewer/web-unit`): 4 files, cohesion 0.33, coupling 0.67
- **Web Viewer/web Viewer/web Viewer** (`web-viewer/web-viewer/web-viewer`): 9 files, cohesion 0.41, coupling 0.59
