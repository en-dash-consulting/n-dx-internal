...
Cross-dependencies between sub-zones:
  ...
  web-viewer/web-viewer/web/viewer → web-viewer/web-viewer/web/viewer-components: 7
  web-viewer/web-viewer/web/viewer → web-viewer/web-viewer/web/viewer-visualization: 5
  web-viewer/web-viewer/web/viewer-components → web-viewer/web-viewer/web/viewer: 16
  web-viewer/web-viewer/web/viewer-components → web-viewer/web-viewer/web/viewer-hooks: 2
  web-viewer/web-viewer/web/viewer-components → web-viewer/web-viewer/web/viewer-performance: 12
  web-viewer/web-viewer/web/viewer-components → web-viewer/web-viewer/web/viewer-visualization: 4
  web-viewer/web-viewer/web/viewer-hooks → web-viewer/web-viewer/web/viewer: 5
  web-viewer/web-viewer/web/viewer-hooks → web-viewer/web-viewer/web/viewer-components: 2
  web-viewer/web-viewer/web/viewer-hooks → web-viewer/web-viewer/web/viewer-visualization: 2
  web-viewer/web-viewer/web/viewer-performance → web-viewer/web-viewer/web/viewer-components: 2
  web-viewer/web-viewer/web/viewer-visualization → web-viewer/web-viewer/web/viewer: 4
  web-viewer/web-viewer/web/viewer-visualization → web-viewer/web-viewer/web/viewer-components: 1
...
- **Web Viewer/web Viewer/web/viewer Visualization** (`web-viewer/web-viewer/web/viewer-visualization`): 8 files, cohesion 0.52, coupling 0.48
