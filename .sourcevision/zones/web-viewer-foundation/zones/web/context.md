...
Zone: Web (`web-2/web`)
Files: 62, Cohesion: 0.94, Coupling: 0.06
Description: 62 files, primarily TypeScript
Entry points: packages/web/src/viewer/components/data-display/health-gauge.ts, packages/web/src/viewer/components/logos.ts, packages/web/src/schema/v1.ts, packages/web/src/viewer/components/search-filter.ts, packages/web/src/viewer/types.ts, packages/web/src/viewer/utils.ts
Lines: 19218
