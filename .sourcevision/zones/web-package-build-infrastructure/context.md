# Web Package Build Infrastructure — Zone Context

<!-- Per-zone context generated by Sourcevision. -->

<zone>

Zone: Web Package Build Infrastructure (`web-package-build-infrastructure`)
Files: 10, Cohesion: 1.00, Coupling: 0.00
Risk: healthy (score: 0.00)
Description: Build tooling, package metadata, and configuration files for the @n-dx/web package, forming the build contract shell separate from the application source code.
Lines: 1544
