# Dashboard Platform — Zone Context

<!-- Per-zone context generated by Sourcevision. -->

<zone>

Zone: Dashboard Platform (`dashboard-platform`)
Files: 144, Cohesion: 1.00, Coupling: 0.00
Description: Unified web dashboard and MCP server that aggregates all domain packages into a single interface for monitoring and tool access.
Lines: 49288
...
[suggestion] [info] Standardize import extensions: either use .js consistently (Node.js ESM style) or .ts extensions throughout the zone for clarity
