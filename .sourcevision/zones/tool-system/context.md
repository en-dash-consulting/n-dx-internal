...
Outgoing (this zone → other zones):
  ...
  → security-guard: packages/hench/src/tools/files.ts → packages/hench/src/guard/paths.ts
...
Incoming (other zones → this zone):
  ...
  ← security-guard: packages/hench/tests/unit/tools/shell.test.ts → packages/hench/src/tools/shell.ts

</imports>

<findings>

[observation] [info] Well-structured tool abstraction with clear contracts and dispatch patterns
