# Hench CLI Interface — Zone Context

<!-- Per-zone context generated by Sourcevision. -->

<zone>

Zone: Hench CLI Interface (`hench-cli`)
Files: 12, Cohesion: 0.72, Coupling: 0.28
Description: Command-line interface layer for the hench autonomous agent, handling user commands and output formatting.
...
Outgoing (this zone → other zones):
  → hench-core: packages/hench/src/agent/brief.ts → packages/hench/src/schema/index.ts; packages/hench/src/cli/commands/run.ts → packages/hench/src/agent/cli-loop.ts; packages/hench/src/cli/commands/run.ts → packages/hench/src/agent/loop.ts; packages/hench/src/cli/commands/run.ts → packages/hench/src/agent/stuck.ts; packages/hench/src/cli/commands/run.ts → packages/hench/src/store/index.ts; packages/hench/src/cli/commands/show.ts → packages/hench/src/store/index.ts; packages/hench/src/cli/commands/status.ts → packages/hench/src/store/index.ts; packages/hench/src/cli/index.ts → packages/hench/src/cli/commands/init.ts; packages/hench/tests/unit/agent/brief.test.ts → packages/hench/src/schema/v1.ts

Incoming (other zones → this zone):
  ← hench-core: packages/hench/src/agent/cli-loop.ts → packages/hench/src/agent/brief.ts; packages/hench/src/agent/cli-loop.ts → packages/hench/src/cli/output.ts; packages/hench/src/agent/loop.ts → packages/hench/src/agent/brief.ts; packages/hench/src/agent/loop.ts → packages/hench/src/cli/output.ts; packages/hench/src/agent/review.ts → packages/hench/src/cli/output.ts; packages/hench/src/cli/commands/init.ts → packages/hench/src/cli/commands/constants.ts; packages/hench/src/cli/commands/init.ts → packages/hench/src/cli/output.ts; packages/hench/tests/unit/cli/commands/run-loop.test.ts → packages/hench/src/cli/commands/run.ts

</imports>

<findings>

[observation] [warning] Bidirectional coupling with hench-2 (9 imports out, 8 in) suggests these zones could potentially be merged or boundaries clarified
[observation] [info] Good cohesion (0.72) for a CLI layer that must integrate with core agent functionality
[anti-pattern] [warning] CLI layer (12 files) is relatively large for what should be a thin wrapper—consider if some logic should move to hench-core
[suggestion] [info] init.ts performs filesystem operations directly rather than delegating to a core module, breaking the thin-wrapper pattern used by run.ts and status.ts
