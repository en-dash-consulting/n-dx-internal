...
Internal:
  packages/sourcevision/src/analyzers/callgraph-findings.ts → packages/sourcevision/src/schema/index.ts {CallGraph, CallEdge, FunctionNode, Finding, Inventory, ImportEdge}
  ...
  packages/sourcevision/src/cli/commands/analyze.ts → packages/sourcevision/src/analyzers/callgraph-findings.ts {generateCallGraphFindings}
  packages/sourcevision/src/cli/commands/analyze.ts → packages/sourcevision/src/analyzers/callgraph.ts {analyzeCallGraph, computeZoneCallStats}
  ...
  packages/sourcevision/src/cli/commands/analyze.ts → packages/sourcevision/src/analyzers/token-usage.ts {emptyAnalyzeTokenUsage, accumulateTokenUsage, formatTokenUsage}
  packages/sourcevision/src/cli/commands/analyze.ts → packages/sourcevision/src/analyzers/workspace.ts {detectSubAnalyses, buildSubAnalysisRefs}
  ...
  packages/sourcevision/src/schema/index.ts → packages/sourcevision/src/schema/validate.ts {ManifestSchema, InventorySchema, ImportsSchema, ZonesSchema, FindingSchema, ComponentsSchema, CallGraphSchema, validateManifest, validateInventory, validateImports, validateZones, validateComponents, validateCallGraph, validateModule, formatValidationErrors}
