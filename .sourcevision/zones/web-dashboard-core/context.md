...
Zone: Web Dashboard Core (`web-dashboard-core`)
...
Incoming (other zones → this zone):
  ← web-mcp-server: packages/web/src/viewer/loader.ts → packages/web/src/schema/data-files.ts; packages/web/src/viewer/main.ts → packages/web/src/schema/data-files.ts; packages/web/tests/integration/pr-markdown-refresh.test.ts → packages/web/src/server/routes-sourcevision.ts; packages/web/tests/integration/pr-markdown-refresh.test.ts → packages/web/src/server/types.ts
