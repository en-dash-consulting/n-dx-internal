...
Zone: Autonomous Agent Core (`autonomous-agent`)
Files: 76, Cohesion: 0.93, Coupling: 0.07
Description: Primary agent execution engine handling task analysis, lifecycle management, and autonomous workflow orchestration.
Entry points: packages/hench/src/schema/index.ts, packages/hench/src/schema/v1.ts, packages/hench/src/tools/exec-shell.ts, packages/hench/src/tools/git.ts, packages/hench/src/types/index.ts
Lines: 16107
...
packages/hench/src/agent/lifecycle/cli-loop.ts (TypeScript, 606 lines, source)
...
Outgoing (this zone → other zones):
  → execution-gateway: packages/hench/src/agent/analysis/review.ts → packages/hench/src/process/index.ts; packages/hench/src/agent/index.ts → packages/hench/src/validation/completion.ts; packages/hench/src/agent/index.ts → packages/hench/src/validation/completion.ts; packages/hench/src/agent/lifecycle/cli-loop.ts → packages/hench/src/process/index.ts; packages/hench/src/agent/lifecycle/cli-loop.ts → packages/hench/src/tools/index.ts; packages/hench/src/agent/lifecycle/cli-loop.ts → packages/hench/src/validation/completion.ts; packages/hench/src/agent/lifecycle/loop.ts → packages/hench/src/process/index.ts; packages/hench/src/agent/lifecycle/loop.ts → packages/hench/src/tools/index.ts; packages/hench/src/agent/planning/brief.ts → packages/hench/src/prd/ops.ts; packages/hench/src/cli/commands/run.ts → packages/hench/src/prd/ops.ts; packages/hench/src/cli/commands/run.ts → packages/hench/src/prd/ops.ts; packages/hench/src/public.ts → packages/hench/src/validation/completion.ts; packages/hench/src/tools/exec-shell.ts → packages/hench/src/process/index.ts; packages/hench/tests/unit/agent/atomic-transition.test.ts → packages/hench/src/tools/rex.ts
  → tool-infrastructure: packages/hench/src/agent/lifecycle/loop.ts → packages/hench/src/guard/index.ts; packages/hench/src/agent/lifecycle/loop.ts → packages/hench/src/tools/dispatch.ts; packages/hench/src/types/index.ts → packages/hench/src/guard/index.ts; packages/hench/tests/unit/agent/task-failure.test.ts → packages/hench/src/agent/tools.ts

Incoming (other zones → this zone):
  ← execution-gateway: packages/hench/src/tools/index.ts → packages/hench/src/tools/git.ts
  ← tool-infrastructure: packages/hench/src/agent/tools.ts → packages/hench/src/types/index.ts; packages/hench/src/guard/index.ts → packages/hench/src/schema/index.ts; packages/hench/src/tools/dispatch.ts → packages/hench/src/tools/git.ts; packages/hench/src/tools/dispatch.ts → packages/hench/src/types/index.ts; packages/hench/src/tools/shell.ts → packages/hench/src/tools/exec-shell.ts; packages/hench/tests/unit/tools/files.test.ts → packages/hench/src/schema/v1.ts; packages/hench/tests/unit/tools/shell.test.ts → packages/hench/src/schema/v1.ts
...
[suggestion] [info] Analysis state machine lacks centralized validation - adaptive.ts, review.ts, stuck.ts operate independently without state consistency checks
[suggestion] [warning] Lifecycle entry points (cli-loop.ts vs loop.ts) should share common validation logic to prevent behavior divergence between CLI and programmatic execution
...
- High cohesion (0.93) indicates strong internal organization around agent responsibilities
- Analysis subsystem provides adaptive behavior and workflow review capabilities
- Lifecycle management separates CLI and programmatic execution paths cleanly
- Strong cohesion (0.93) with minimal coupling (0.07) demonstrates well-designed agent architecture
- Analysis subsystem provides sophisticated agent capabilities including adaptive behavior and stuck detection
- Multiple entry points indicate flexible integration patterns for different consumption scenarios
- Forms the core processing engine with sophisticated internal modularity but clear external interfaces
- Bidirectional coupling with execution-gateway suggests potential interface extraction opportunity
- Gateway module naming inconsistency: uses 'prd/ops.ts' instead of standard 'gateway.ts' or 'deps.ts' pattern seen elsewhere
- Complete architectural isolation with zero coupling despite being largest zone (101 files) demonstrates exceptional design discipline
- CLI-heavy composition creates very low public API surface (types/schema only) preventing inappropriate library usage patterns
- Gateway module naming inconsistency: uses 'prd/ops.ts' instead of standard 'gateway.ts' or 'deps.ts' pattern seen in web package (mcp-deps.ts)
- Analysis subsystem (adaptive.ts, review.ts, stuck.ts) implements sophisticated state machine but lacks centralized state validation
- Multiple lifecycle entry points (cli-loop.ts, loop.ts) suggest different execution contexts but create potential behavior divergence
- Lifecycle entry points (cli-loop.ts vs loop.ts) should share common validation logic to prevent behavior divergence between CLI and programmatic execution
- Analysis state machine lacks centralized validation - adaptive.ts, review.ts, stuck.ts operate independently without state consistency checks
- [call graph] 1600 internal calls, 57 outgoing, 4 incoming (cohesion: 0.97, coupling: 0.03)
...
- **Tests** (`hench/tests`): 71 files, cohesion 1, coupling 0
- **Store** (`hench/store`): 2 files, cohesion 1, coupling 0
- **Tools** (`hench/tools`): 3 files, cohesion 1, coupling 0
